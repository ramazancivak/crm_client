    ...
    <div> 
        <form @submit.prevent="handleSubmit">
            <div class="w-full border-b mb-4 flex justify-between">
                ...
                <div>
                    <div class="grid gap-5 items-center" :class="isNew ? 'grid-cols-2' : 'grid-cols-1'" v-if="!isNew">
                        <div class="group flex items-center" v-if="formData.register_done">
                        ...
                        <div v-else>
                            <div class="text-red-600">Çalışan henüz kaydınız tamamlamamış</div>
                            <CustomButton @click="reSend" class="mt-1" icon="fa-share">
                                Hatırlatma
                            </CustomButton>
                        </div>
                    </div>
            ...
            <div class="w-full border-b mb-4">
                ...
                <div class="grid gap-5 grid-cols-5 w-100 py-4">
                    ...
                    <div class="group">
                        <label for="food_card_number" class="block mb-1 text-sm w-100">Yemek Kartı Numarası <span class="float-right">CVV</span></label>
                        <div class="relative">
                            <input type="text" id="food_card_number" v-model="formData.food_card_number" class="diji-input">
                            <input type="text" id="food_card_cvv" v-mask="'###'" placeholder="CVV" v-model="formData.food_card_cvv" class="diji-input !w-[50px] absolute right-0 top-0">
                        </div>
                    </div>
                    <div class="group">
            ...
            <div class="w-full border-b mb-4 pb-4"> 
                ...
                <div v-else class="grid gap-5 grid-cols-5 w-100 py-4 items-end" v-for="(fixture, index) in fixtures" :key="index">
                    <div class="group">
                        ...
                        <input type="text" v-model="fixture.name" disabled :id="'fix_name'+index" class="diji-input">
                    </div>
                </div>
            </div>
            -->
